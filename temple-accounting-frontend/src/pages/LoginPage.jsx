...
export default function LoginPage() {
  ...
  const { login, register, isLoading, error, validationErrors, clearError } = useAuthStore();
            ...
            <>
              ...
              <div>
                <Input
                  ...
                  required
                />
                {validationErrors.temple_name && (
                  <p className="text-red-500 text-sm mt-1">{validationErrors.temple_name}</p>
                )}
              </div>
            </>
          )}
